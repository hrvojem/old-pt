...
#ysql -e "CREATE FUNCTION keyring_key_remove returns integer SONAME 'keyring_udf.so';"
#ysql -e "CREATE FUNCTION keyring_key_generate returns integer SONAME 'keyring_udf.so';"
#ysql -e "CREATE FUNCTION keyring_key_store returns integer SONAME 'keyring_udf.so';"
